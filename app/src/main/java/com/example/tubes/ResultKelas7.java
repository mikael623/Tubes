...
public class ResultKelas7 extends AppCompatActivity {
    private Button menuawal;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_result_kelas7);
        ...
        menuawal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(ResultKelas7.this, DashBoard.class));
                finish();
            }
        });
    ...
    public void onClick(View view) {
        Intent intent = new Intent(ResultKelas7.this, ListQuiz.class);
