...
public class ChatBotAdapter extends RecyclerView.Adapter {
    ...
    public ChatBotAdapter(ArrayList<ChatData> chatList, Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case 0:
                ...
                view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_chat_msg, parent, false);
                return new UserViewHolder(view);
            case 1:
                // below line we are inflating bot message layout.
                view = LayoutInflater.from(parent.getContext()).inflate(R.layout.bot_chat_msg, parent, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ChatData modal = chatList.get(position);
