...
public class ResultKelas8 extends AppCompatActivity {
    private Button menuawal;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_result_kelas8);
        ...
        menuawal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(ResultKelas8.this, DashBoard.class));
                finish();
            }
        });
    ...
    public void onClick(View view) {
        Intent intent = new Intent(ResultKelas8.this, ListQuiz.class);
