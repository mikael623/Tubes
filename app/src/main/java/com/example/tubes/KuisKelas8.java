...
import com.example.tubes.data.KumpulanSoalKelas8;
...
public class KuisKelas8 extends AppCompatActivity {
    ...
    private static String myURL = "http://192.168.40.183/database/get_data_soaldelapan.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kuis_kelas8);
    ...
    private class GetSoal extends AsyncTask<String, String, String> {
        ProgressDialog pb = new ProgressDialog(KuisKelas8.this);
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(KuisKelas8.this);
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                Toast.makeText(KuisKelas8.this, e.toString(), Toast.LENGTH_LONG).show();
                pb.dismiss();
            }
    ...
    private View.OnClickListener klikSelesai = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            tampilKotakAlert = new AlertDialog.Builder(KuisKelas8.this)
                    .create();
