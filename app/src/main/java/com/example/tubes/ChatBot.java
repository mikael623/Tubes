...
import com.example.tubes.adapter.ChatBotAdapter;
...
public class ChatBot extends AppCompatActivity {
    ...
    private ArrayList<ChatData> messageModalArrayList;
    ...
    private void sendMessage(String userMsg) {
        ...
        messageModalArrayList.add(new ChatData(userMsg, USER_KEY));
        messageRVAdapter.notifyDataSetChanged();

        // url for our brain
        // make sure to add mshape for uid.
        // make sure to add your url.
        String url = "http://api.brainshop.ai/get?bid=157004&key=wXj0G8U5EFQdY3WJ&uid=[uid]&msg=" + userMsg;
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    messageModalArrayList.add(new ChatData(botResponse, BOT_KEY));
                    ...
                    messageModalArrayList.add(new ChatData("No response", BOT_KEY));
                    messageRVAdapter.notifyDataSetChanged();
                }
            }
            ...
            public void onErrorResponse(VolleyError error) {
                // error handling.
                messageModalArrayList.add(new ChatData("Sorry no response found", BOT_KEY));
