...
//import com.example.tubes.data.ServiceHandler;
...
public class KuisKelas7 extends AppCompatActivity {
    ...
    private static String myURL = "http://192.168.43.246/database/get_data_soal.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kuis_kelas7);
    ...
    private class GetSoal extends AsyncTask<String, String, String> {
        ProgressDialog pb = new ProgressDialog(KuisKelas7.this);
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(KuisKelas7.this);
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                Toast.makeText(KuisKelas7.this, e.toString(), Toast.LENGTH_LONG).show();
                pb.dismiss();
            }
    ...
    private View.OnClickListener klikSelesai = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            tampilKotakAlert = new AlertDialog.Builder(KuisKelas7.this)
                    .create();
