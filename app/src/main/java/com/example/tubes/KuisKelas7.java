...
public class KuisKelas7 extends AppCompatActivity {
    private KumpulanSoalKelas7 mQuestionLibrary = new KumpulanSoalKelas7();
    ...
    private void updateQuestion(){
        if(mQuestionNumber<mQuestionLibrary.getLength() ){
            ...
            Intent intent = new Intent(KuisKelas7.this, ResultKelas7.class);
    ...
    public void onClick(View view) {
        ...
        if (answer.getText() == mAnswer){
            mScore = mScore + 1;
            Toast.makeText(KuisKelas7.this, "Benar!", Toast.LENGTH_SHORT).show();
        }else
            Toast.makeText(KuisKelas7.this, "Salah!", Toast.LENGTH_SHORT).show();
